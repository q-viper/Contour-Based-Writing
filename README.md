...
Well, the line above is just a joke. This project is in development, and I am wondering which features to add next. I get feedback from people on [LinkedIn](https://www.linkedin.com/in/qramkrishna/), and I am always grateful for their support. Many people have supported this project from [LinkedIn post](https://www.linkedin.com/feed/update/urn:li:activity:6699919193124548608/). 
...
## Demo
[Please follow this link to view the demo video](https://q-viper.github.io/assets/contour-writing/web%20app.mp4).

## Introduction
The primary focus of this project is to perform a Gesture-Based Writing System(but it is still working by contours). But I have not used Gesture recognition here. In fact, until the [5th version](https://q-viper.github.io/2020/08/28/gesture-based-visually-writing-system-web-app/) of this project, I have not added a  gesture recognition scheme. Hence, the correct name is Contour-Based Writing System. The entire concept of the working system can be clearly understood by reading the [blog of the first version](https://q-viper.github.io/2020/08/01/gesture-based-visually-writing-system-using-opencv-and-python/), where I have tried to explain theoretical concepts and all the working ideas. If you have any ideas or thoughts about the system, please contact me on [LinkedIn](https://www.linkedin.com/in/ramkrishna-acharya-91a217183/). 
...
## Implementation
Until the 5th version, the system was only Python code, with no implementation. However, I have made it web-based. But this web application is only runnable locally.
